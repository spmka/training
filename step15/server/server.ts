...
import {HardwareUsageEndPointsController} from './hardware-usage/hardware-usage-end-points.controller';
...
class Server extends AbstractExpressServer {
  ...
  protected setupEndPoints() {
    ...
    this.expressServer.use(this.hardwareUsagesBaseUrl,
      new HardwareUsageEndPointsController().initializeEndPoints());
  }
}
